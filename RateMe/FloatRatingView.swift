        ...
        didSet {
            ...
            for imageView in emptyImageViews {
                if emptyImageViews.index(of: imageView)! == 0 {
                    ...
                    imageView.image = UIImage(named: "cup-302")
                } else if emptyImageViews.index(of: imageView)! == 3 {
    ...
    @IBInspectable open var fullImage: UIImage? {
        didSet {
            ...
            for imageView in fullImageViews {
                ...
                } else if fullImageViews.index(of: imageView)! == 2 {
                    imageView.image = UIImage(named: "cup-32")
                } else if fullImageViews.index(of: imageView)! == 3 {
